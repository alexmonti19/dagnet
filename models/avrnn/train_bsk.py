...
from models.avrnn.model import AVRNN
from models.avrnn.data.loader_bsk import data_loader
from models.avrnn.evaluate_bsk import evaluate
from models.utils.adjacency_matrix import compute_adjs, compute_adjs_distsim, compute_adjs_knnsim
...
parser.add_argument('--num_epochs', default=300, type=int, required=False, help='Training epochs number')
...
def test(args, epch, test_loader, model, warmup, writer):
    ...
    with torch.no_grad():
        for batch_idx, data in enumerate(test_loader):
            ...
            samples_rel = model.sample(args.pred_len, h, obs_traj[-1], seq_start_end)
